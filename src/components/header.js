    ...
    <div className="header-header">
      ...
      >
        ...
        <div className="header-container">
          <div data-thq="thq-navbar-nav" className="header-desktop-menu">
            ...
            <div className="header-buttons">
              <Link to="/contact-us" className="header-contact-us buttonFilled">
                {props.register}
              </Link>
            </div>
          </div>
        ...
        <div data-thq="thq-burger-menu" className="header-burger-menu">
          <svg viewBox="0 0 1024 1024" className="header-icon02 socialIcons">
        ...
        >
          <div className="header-nav">
            ...
            <nav className="header-links1">
              <span className="header-nav12 bodySmall">{props.nav12}</span>
              ...
              <span className="header-nav52 bodySmall">{props.nav52}</span>
            </nav>
          ...
          <div>
            ...
            <svg
              ...
              className="header-icon10 socialIcons"
            >
...
Header.defaultProps = {
  ...
  imageAlt: 'image',
  text: 'Link',
  link1: 'Industries Served',
  nav42: 'Pricing',
  logo1: 'WEBMASTERS',
  imageSrc: '/pixelcoulee-logo.svg',
  register1: 'Register',
  text1: 'Industries Served',
  register: 'Contact Us',
  login: 'Login',
}
