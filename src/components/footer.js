      ...
      <footer className="footerContainer footer-footer1">
        <div className="footer-container">
          ...
          <nav className="footer-nav">
            ...
            <Link to="/contact-us" className="footer-nav52 bodySmall">
              {props.nav52}
            </Link>
          </nav>
        </div>
        ...
        <div className="footer-container1">
          <div className="footer-container2">
            <span className="bodySmall footer-text">{props.text1}</span>
            <span className="footer-date-time">
              <DateTimePrimitive
                format="YYYY"
                date="Wed Apr 24 2024 20:45:30 GMT-0500 (Central Daylight Time)"
              ></DateTimePrimitive>
            </span>
            <span className="bodySmall footer-text1">{props.text}</span>
          </div>
...
Footer.defaultProps = {
  ...
  text1: '©',
  nav52: 'Contact Us',
  text: 'pixelcoulee.com, All Rights Reserved.',
  logo: 'WEBMASTERS',
  nav12: 'Home',
  nav22: 'Services',
  nav42: 'Pricing',
